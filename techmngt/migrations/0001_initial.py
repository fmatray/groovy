...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='techflow',
            name='subfunc_flow',
            field=models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='techflow_subflow', to='funcmngt.SubFuncFlow', verbose_name='Functional Sub Flow'),
        ),
        migrations.AddField(
            model_name='techflow',
            name='tags',
        ...
        migrations.AddField(
            ...
            name='protocol',
            field=models.ForeignKey(limit_choices_to={'type': 'Asynchronous'}, on_delete=django.db.models.deletion.CASCADE, related_name='asynchronousflow_protocol', to='techmngt.Protocol', verbose_name='Protocol'),
        ),
        migrations.AddField(
            model_name='asynchronousflow',
            name='tags',
        ...
        migrations.AddField(
            ...
            name='input_flow',
            field=models.OneToOneField(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='batch_input_flow', to='techmngt.AsynchronousFlow', verbose_name='Input Flow'),
        ),
        migrations.AddField(
            model_name='batchflow',
            name='output_flow',
            field=models.OneToOneField(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='batch_output_flow', to='techmngt.AsynchronousFlow', verbose_name='Output Flow'),
        ),
    ]
